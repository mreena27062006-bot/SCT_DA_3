...
| `assets/01_Dashboard_Overview.png` | Full dashboard screenshot |
| `assets/02_Dept_Attrition_PieChart.png` | Attrition by Department chart |
| `assets/03_AgeGroup_Attrition_Treemap.png` | Attrition by Age Group treemap |
| `assets/04_Gender_Attrition_BarChart.png` | Attrition by Gender chart |
| `assets/05_JobSatisfaction_BarChart.png` | Job Satisfaction by Role chart |
| `assets/06_Overtime_Attrition_BarChart.png` | Overtime vs Attrition chart |
